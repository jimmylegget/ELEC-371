...
Init:
    ...
    stwio	r5, 0(r4)				# Store the lowere 16 bits in start lo register
...
isr:
    ...
    ldwio	r4, 0(et)					# Raad the timer status register
    ...
    xori	r4, r4, 2					# Toggle the 2nd LED status
...
not_timer:
    ...
    movia	et, LEDS
    ldwio	r4, 0(et)					# Read LED status
    xori	r4, r4, 1					# Toggle the 1st LED status
    stwio	r4, 0(et)					# Set LED status
